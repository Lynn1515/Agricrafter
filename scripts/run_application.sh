...
ckpt=/home/cx_wchn/lnwang/DynamiCrafter-main/main/interp_output/training_512_v1.0_interp/checkpoints/trainstep_checkpoints/epoch=178-step=60000.ckpt #checkpoints/dynamicrafter_512_interp_v1/model.ckpt
...
if [ "$1" == "interp" ]; then
seed=12306
name=interp_60000_dynamicrafter_512_$1_seed${seed}
